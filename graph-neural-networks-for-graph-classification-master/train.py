...
from graph_data_reader import DataReader, GraphData
from models.GCN import GCN
from models.GAT import GAT
from models.GraphSAGE import GraphSAGE
from utils import create_directory, save_result_csv

model_list = ['GCN', 'GAT', 'GraphSAGE', 'APPNP', 'GIN', 'GraphUNet', 'ARMA', 'SGCNN', 'GraphResNet']
dataset_list = ['PROTEINS', 'ENZYMES', 'OV', 'MUTAG']
readout_list = ['max', 'sum', 'avg']
